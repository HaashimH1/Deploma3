...
class GoogleSheets:
    ...
    def __init__(self):
        """
        Setting up the attributs for the GoogleSheets objects for using the API easily
    ...
    def add_visit(self,date,Id,visits_data):
        ...
        param date: date of visit logged
              ...
              visits_data: the data of all visits from this profile prior to this visit being logged
    ...
    def add_payment(self,payment_amount,today_date,enddate,Id,payments_data):
        ...
        param payment_amount: amount of payment
              ...
              Id: profiles ID being updated
              payments_data: the data of all payments from this profile prior to this payment being logged
        """
